...
>(({ className, inset, ...props }, ref) => (
	<ContextMenuPrimitive.Item
		ref={ref}
		className={cn(
			'relative flex select-none items-center rounded-lg px-2 py-1.5 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50  hover:bg-purple-heart-400/40 cursor-pointer transition-colors',
			inset && 'pl-8',
			className
		)}
		{...props}
...
const ContextMenuShortcut = ({
	...
	return (
		<span
			className={cn(
				'ml-auto text-xs tracking-widest text-mine-shaft-200',
				className
			)}
			{...props}
		/>
