...
export type MutationNew_ContentsArgs = {
  createManyContentDto: Array<CreateContentDto>;
};
...
export type NewContentsMutationVariables = Exact<{
  createManyContentDto: Array<CreateContentDto> | CreateContentDto;
}>;
...
export const NewContentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"newContents"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"createManyContentDto"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateContentDto"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"new_contents"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"createManyContentDto"},"value":{"kind":"Variable","name":{"kind":"Name","value":"createManyContentDto"}}}]}]}}]} as unknown as DocumentNode<NewContentsMutation, NewContentsMutationVariables>;
