...
export type CreateContentManyDataInput = {
  sentence: Scalars['String']['input'];
  transcription?: InputMaybe<Scalars['String']['input']>;
  translation: Scalars['String']['input'];
};

export type CreateManyContentDto = {
  data: Array<CreateContentManyDataInput>;
  themeId: Scalars['String']['input'];
};
...
export type Mutation = {
  ...
  new_content: Content;
  new_contents: Scalars['Int']['output'];
  new_theme: Theme;
  ...
  validate_refresh_token: Scalars['Boolean']['output'];
};
...
export type MutationNew_ContentsArgs = {
  createManyContentDto: CreateManyContentDto;
};
...
export type ValidateRefreshTokenMutationVariables = Exact<{ [key: string]: never; }>;


export type ValidateRefreshTokenMutation = { __typename?: 'Mutation', validate_refresh_token: boolean };
...
export type NewContentsMutationVariables = Exact<{
  createManyContentDto: CreateManyContentDto;
}>;


export type NewContentsMutation = { __typename?: 'Mutation', new_contents: number };
...
export const ValidateRefreshTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"validateRefreshToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"validate_refresh_token"}}]}}]} as unknown as DocumentNode<ValidateRefreshTokenMutation, ValidateRefreshTokenMutationVariables>;
...
export const NewContentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"newContents"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"createManyContentDto"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateManyContentDto"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"new_contents"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"createManyContentDto"},"value":{"kind":"Variable","name":{"kind":"Name","value":"createManyContentDto"}}}]}]}}]} as unknown as DocumentNode<NewContentsMutation, NewContentsMutationVariables>;
